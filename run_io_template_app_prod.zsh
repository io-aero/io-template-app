...
# ------------------------------------------------------------------------------
#
# run_io_template_app_prod.zsh: Process IO-TEMPLATE-APP tasks.
#
# ------------------------------------------------------------------------------
...
log_file="run_io_template_app_prod_${IO_AERO_TASK}.log"
...
case "${IO_AERO_TASK}" in
    "version")
	    if ! ( ./dist/macos/iotemplateapp -t "${IO_AERO_TASK}" ); then
            exit 255
        fi
        ;;
